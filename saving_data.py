...
def saving_mlp(summry, args, no = 0):
	...
	# 損失関数と正解率をエクセルデータに保存
	with open('./result/train/value/mlp_value_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_units{}_mno{}.csv'.format(args.day, args.norm, args.l_lr, args.shoki_opt, args.out, args.lossf,  args.func, args.opt, args.lr, args.data_model, args.model,args.train_number, args.mlp_units, no), 'w') as f:
		writer = csv.writer(f, lineterminator='\n', delimiter='\t')
		writer.writerows(summry[0])
